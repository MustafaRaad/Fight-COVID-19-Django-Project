...
function DataTypes({covidData, selectedRegions, selectedTypes, onTypeChange}) {
  ...
  return e('form', { className: 'form-inline  d-flex justify-content-end'}, dataTypes);
}
...
function TableFilters({
  ...
  return (
    e('form', { className: 'form-inline  d-flex justify-content-center'},
      ...
      //   e(Toggle, {checked: groupByCountry, onChange: onGroupByCountries, text: 'ترتيب حسب الدولة'})
      // ),
